...
class Configuration:
    ...
    def validate(self):
        ...
        if (self.__configurations["connector_platform_type"] and isinstance(
        ...
        elif (self.__configurations["connector_platform_type"] and isinstance(self.__configurations[

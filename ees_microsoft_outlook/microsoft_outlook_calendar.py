...
class MicrosoftOutlookCalendar:
    ...
    def convert_calendars_to_workplace_search_documents(
        self, ids_list_calendars, calendar_obj, user_email_address, start_time, end_time, child_calendar
    ):
        ...
        if calendar_obj.last_modified_time:
            calendar_created = change_datetime_format(calendar_obj.last_modified_time, self.time_zone)
        ...
        if "Folder (Birthdays)" in child_calendar:
        ...
        if calendar_obj.has_attachments:
            calendar_attachments_documents = self.get_calendar_attachments(
                ids_list_calendars, calendar_obj, user_email_address, start_time, end_time
            )
            ...
            try:
                ...
                for calendar in account.calendar.filter(
                    ...
                    (
                        ...
                        ids_list_calendars, calendar, account.primary_smtp_address, start_time, end_time,
                        str(calendar)
                    )
                    calendar_map = {}

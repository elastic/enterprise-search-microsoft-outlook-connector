...
class MicrosoftOutlookMails:
    ...
    def get_mail_attachments(self, ids_list_mails, mail_obj, user_email_address, start_time, end_time):
        ...
        for attachment in mail_obj.attachments:
            ...
            if attachment.last_modified_time:
                attachment_created = change_datetime_format(attachment.last_modified_time, self.time_zone)
    ...
    def convert_mails_to_workplace_search_documents(
        self, ids_list_mails, mail_type, mail_obj, user_email_address, start_time, end_time
    ):
        ...
        if mail_obj.last_modified_time:
            mail_created = change_datetime_format(mail_obj.last_modified_time, self.time_zone)
    ...
    def get_mail_documents(self, account, ids_list_mails, mail_type, mail_objs, start_time, end_time):
        ...
        for mail_obj in mail_objs:
            ...
            (
                ...
                ids_list_mails, mail_type, mail_obj, account.primary_smtp_address, start_time, end_time
            )
            mail_map = {}

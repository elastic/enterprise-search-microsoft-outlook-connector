...
class MicrosoftOutlookTasks:
    ...
    def get_task_attachments(self, ids_list_tasks, task_obj, user_email_address, start_time, end_time):
    ...
    def convert_tasks_to_workplace_search_documents(
        ...
        if task_obj.last_modified_time:
            task_created = change_datetime_format(task_obj.last_modified_time, self.time_zone)
        ...
        if task_obj.complete_date:
            task_complete = change_datetime_format(task_obj.complete_date, self.time_zone)
            ...
            try:
                ...
                for task in (
                    ...
                    (
                        ...
                        task, ids_list_tasks, account.primary_smtp_address, start_time, end_time
                    )
                    task_map = {}
